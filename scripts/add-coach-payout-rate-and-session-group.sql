-- Add per-coach payout rate (founding coaches may get different %)
-- Default is 0.8333 (5/6 = 83.33%) but can be overridden per coach
ALTER TABLE public.athletes
ADD COLUMN IF NOT EXISTS payout_rate DECIMAL(4,4) DEFAULT 0.8333;
...
ALTER TABLE public.sessions
ADD COLUMN IF NOT EXISTS session_payout_rate DECIMAL(4,4);
