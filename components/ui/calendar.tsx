  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          "bg-levelup-primary text-primary-foreground hover:bg-levelup-primary hover:text-primary-foreground focus:bg-levelup-primary focus:text-primary-foreground rounded-md",
